function voc_test_models(feat_collection, weights)
    addpath('../src/');
    ...
    DefaultVal('*feat_collection', '''all_feats_pca_noncent_5000_Plus_fisher_gmm_128''');
    if(~isempty(weights))
    ...
    if 1
      ...
      name = {[imgset_train '_' feat_collection '_3.000000']};
    else
      imgset_ho = 'test11';
