...
im_test_dir = '../VOC_experiment/Test/VOCdevkit/VOC2011/JPEGImages/' ;
cpmc_dir = '../VOC_experiment/cpmc_segms_150/' ;
masks_dir = '../VOC_experiment/VOC/MySegmentsMat/CPMC_segms_150_sp_approx' ;

%% Save to directory
fish_dir = '../VOC_experiment/VOC/MyFisherMat/CPMC_segms_150_sp_approx/gmm128_test/' ;

load('voc2011_model-128GMM.mat') ;
model.ss = 1 ;
...
%% Save to directory
fishgt_dir = '../VOC_experiment/VOC/MyFisherMat/ground_truth_sp_approx/gmm128_test' ;
